    ...
    stages {
        ...
        stage('compile') {
            ...
            post {
                ...
                success {
                    discordSend description: "${env.GIT_COMMIT}", footer: "${env.BUILD_NUMBER}", image: '', link: "${env.GIT_BRANCH}", result: 'SUCCESS', thumbnail: '', title: "Jérémy", webhookURL: 'https://discordapp.com/api/webhooks/747819422705778738/dHWPHidlNLpiiKftWU84__Ss2LAkws77Swfdk5OWs22qla3hlI1B4zywW8ROg4nAwjRM7'
                }
            }
        }
    }
